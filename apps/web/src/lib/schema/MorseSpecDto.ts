...
import type { MorseServerDto } from "./MorseServerDto";

export type MorseSpecDto = { id: string, 
/**
 * The linked repo holding it (Mode A), absent for this workspace.
 */
repo: string | null, path: string, title: string | null, version: string | null, head: string | null, 
/**
 * The document's `servers:`. A relative `/` names no host, and the
 * screen says so before anyone presses Send.
 */
servers: Array<MorseServerDto>, operations: Array<MorseOperationDto>, 
/**
